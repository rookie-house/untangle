                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={cn(
                                        ...
                                        isOpen ? "opacity-100" : "opacity-0 w-0 -ml-2 lg:group-hover:opacity-100 lg:group-hover:w-auto lg:group-hover:ml-0"
                                    )}>
                                        {item.name}
                                    </span>
                                </Link>
                ...
                <div className="border-t p-4">
                    <div className={cn(
                        ...
                        <div className={cn(
                            ...
                            isOpen ? "opacity-100 w-auto" : "opacity-0 w-0 lg:group-hover:opacity-100 lg:group-hover:w-auto"
                        )}>
