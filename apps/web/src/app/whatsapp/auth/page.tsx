					...
					<div className="mt-4 p-6 bg-red-50 border-2 border-red-200 rounded-lg">
						...
						<div className="text-center">
							...
							<p className="text-red-700 mb-4">
								No valid session ID found. WhatsApp authentication requires a
								valid session identifier.
							</p>
							<div className="bg-red-100 p-3 rounded border border-red-300 text-sm text-red-800">
								<strong>Note:</strong> Please ensure you accessed this page
								through a valid WhatsApp authentication link or contact support
