...
--> statement-breakpoint
INSERT INTO `__new_documents`("id", "title", "type", "r2_key", "url", "userId", "sessionId", "updatedAt", "createdAt") SELECT "id", "title", "type", "r2_key", "url", "userId", "sessionId", "updatedAt", "createdAt" FROM `documents`;--> statement-breakpoint
